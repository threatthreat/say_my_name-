...
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1002522586530'))  # Notification of those who verify will be sent to your channel
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002345626874').split()]
...
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1002665145530').split()]
...
DEENDAYAL_VERIFIED_LOG = int(environ.get('DEENDAYAL_VERIFIED_LOG', '-1002345626874'))  # Log channel id (make sure bot is admin)
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/Bombardiro_Crocodiloa')  # How to open tutorial link for verification
...
SHORTLINK_API = environ.get('SHORTLINK_API', '0123cbbcb7da6b4d5eb066e3f5545ef53ecee5bd')
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/rexiebotz')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/TylerDurden_T4')
DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/rexie_update')
